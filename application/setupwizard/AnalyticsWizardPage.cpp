...
void AnalyticsWizardPage::retranslate()
{
    ...
    textBrowser->setHtml(tr(
        "<html><body>"
        "<p>BSDMC sends anonymous usage statistics on every start of the application. This helps us decide what platforms and issues to focus on.</p>"
        ...
        "<ul><li>A random unique ID of the BSDMC installation.<br />It is stored in the application settings (BSDMC.cfg).</li>"
